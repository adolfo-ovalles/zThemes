...
![zDarkTheme](zThemes_zDark-Cover.png)
...
3. Locate your FontForge **`pixmaps`** folder:</br>
...
4. Copy the contents of the **`pixmaps`** folder from the extracted **`zDark`** and overwrite your FontForge **`pixmaps`** folder
...
![zDarkTheme Preview](zThemes_zDark-Previews.png)
